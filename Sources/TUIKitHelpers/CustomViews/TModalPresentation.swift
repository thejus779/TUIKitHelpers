...
/**
 ...
 - Remark: See also `TModalDismisser` for dismissing.
 */

public final class TModalPresenter: NSObject, UIViewControllerAnimatedTransitioning {
...
/**
 Animated transition for dismissing modal view controllers presented with `TModalPresenter`.
 
 - Remark: See also `TModalPresenter` for more information.
 */

public final class TModalDismisser: NSObject, UIViewControllerAnimatedTransitioning {
    let transition: Transition
