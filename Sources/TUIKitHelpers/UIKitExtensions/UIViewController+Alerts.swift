...
extension UIViewController {
    ...
    func presentAlert(title: String?, message: String?, completion: (() -> Void)? = nil) {
        ...
        ac.addButton(title: L10n.Common.ok, style: .default, handler: nil)
    ...
    func presentAlert(title: String,
                      ...
                      cancelText: String? = L10n.Common.no,
                      okText: String = L10n.Common.yes,
    ...
    func presentCancelAlert(
        ...
        cancelText: String = L10n.Common.no) {
        let ac = UIAlertController(title: title, message: message, preferredStyle: .alert)
        ac.addButton(title: cancelText, style: .destructive, handler: { action in
